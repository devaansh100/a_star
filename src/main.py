...
if __name__ == '__main__':
	...
	parser.add_argument('--dataset', required =  True, choices = ['maze-grade', 'maze-eval', 'maze-large', 'maze-small', 'maze-tiny', 'boxoban-tiny', 'boxoban-grade', 'boxoban-eval', 'boxoban-large', 'boxoban-small'])
	...
	parser.add_argument('--sample', choices = ['optimal', 'optimal_easy', 'optimal_med', 'optimal_hard'], default = 'optimal')
